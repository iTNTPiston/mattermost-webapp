                ...
                <div>
                    <div className='backstage-filters'>
                        <div className='backstage-filter__search'>
                            ...
                            <LocalizedInput
                                ...
                                placeholder={{id: t('emoji_list.search-private2'), defaultMessage: 'Search Friends'}}
                    ...
                    <span className='backstage-list__help'>
                        <p>
                            <FormattedMessage
                                id='emoji_list.help3'
                                defaultMessage="Friends are the people you can chat with."
                            />
                        </p>
                        {/* <p>
                            <FormattedMessage
            ...
            <div>
                <div className='backstage-filters'>
                    <div className='backstage-filter__search'>
                        ...
                        <LocalizedInput
                            type='search'
                            className='form-control'
                            placeholder={{id: t('emoji_list.search3'), defaultMessage: 'Search Requests'}}
                            onChange={this.onSearchChange}
                            style={style.search}
                        />
                    </div>
                ...
                <span className='backstage-list__help'>
                    <p>
                        <FormattedMessage
                            id='emoji_list.help4'
                            defaultMessage="Requests must be accepted to send and receive message from friends."
                        />
                    </p>
