...
module.exports = function() {
  return new Worker(__webpack_require__.p + "1fc31e4745967c6309a8.worker.js");
};
...
function indexed_db_create(channelName, options) {
  ...
  return createDatabase(channelName).then(function (db) {
    var state = {
      ...
      options: options,
      uuid: Object(util["e" /* randomToken */])(),
...
function localstorage_postMessage(channelState, messageJson) {
  return new Promise(function (res) {
    Object(util["f" /* sleep */])().then(function () {
      ...
      var writeObj = {
        token: Object(util["e" /* randomToken */])(),
...
function localstorage_create(channelName, options) {
  ...
  var uuid = Object(util["e" /* randomToken */])();
  /**
   * eMIs
   * contains all messages that have been emitted before
   * @type {ObliviousSet}
...
if (util["a" /* isNode */]) {
   ...
   */
  var NodeMethod = __webpack_require__(17);
  /**
...
// CONCATENATED MODULE: ./node_modules/broadcast-channel/dist/es/broadcast-channel.js
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                this.channel = new broadcast_channel_BroadcastChannel(options.instanceName, {
